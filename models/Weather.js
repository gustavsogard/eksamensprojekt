    ...
    return new Promise((resolve, reject) => {
        ...
        connection.on('connect', (err) => {
            if (err) {
                ...
                switch (operation) {
                    case 'historical':
                        query = 'INSERT INTO weater_historical (city, date, degrees) VALUES (@city, @date, @degrees)';
                        parameters = {
                            city: TYPES.VarChar,
                            date: TYPES.DateTime,
                            degrees: TYPES.Int
                        ...
                        break;
                    case 'forecast':
                        query = 'INSERT INTO weater_forecast (city, date, degrees) VALUES (@city, @date, @degrees)';
                        parameters = {
                            city: TYPES.VarChar,
                            date: TYPES.DateTime,
                            degrees: TYPES.Int
